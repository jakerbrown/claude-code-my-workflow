...
- Which Authors in a New Yorker Corpus Write Most Like Philip Roth?
- The Most Roth-Like Writers in a Legal Mini-Corpus
- Beyond the Usual Comparisons: A Corpus-Bounded Search for Philip Roth's Closest Cousins

# Standfirst

I built a legal mini-corpus of publicly accessible fiction and excerpts, then
compared Philip Roth to a broader set of modern literary authors across topic,
style, social-world vocabulary, confessional markers, and emotional-moral
vocabulary. The result is not the usual “critics say X” list. It is stranger,
more defensible, and, within this corpus, genuinely surprising.
...
Hemon / Hadley recommendation angle visible at a glance rather than only in
prose.
...
vocabulary. Lahiri is a style outlier. Díaz and Gaitskill stay bright in
...
Among the top Roth-adjacent authors in this corpus, you have **already read**
...
the analysis says you have already covered several of the best-supported
matches, and the two most obvious unread next authors are Hemon and Hadley.
...
1. **Aleksandar Hemon** if you want the strongest high-ranking match you have
   not yet logged on Goodreads.
2. **Tessa Hadley** if you want another high-ranking unread author with strong
   emotional and social-world proximity.
3. **Junot Díaz** if you want the strongest overall match to reread or revisit.
4. **Mary Gaitskill** if you want the sharpest confessional and erotic analogue.
5. **Don DeLillo** if you want thematic and institutional adjacency rather than
...
- Corpus: 46 usable *New Yorker* fiction texts / excerpts, 328,824 words.
- Anchor corpus: 8 Philip Roth texts spanning 1959-1998.
- Candidate authors: 10 modern literary-fiction comparators with at least 3
  usable texts each.
- Feature families: topic, style, social-world vocabulary, confessional
  markers, emotional-moral vocabulary.
- Composite: equal weights, plus sensitivity checks under alternative weights.
- Main limitations: New Yorker-only corpus, English-only pass, no full-book
  access, and a robustness appendix that is still lighter than ideal.

# Bibliography / data notes

- See `bibliography.md` for the primary corpus URLs.
- See `methods_memo.md` for the access and reproducibility notes.
